    ...
    <main className="graph-paper relative min-h-screen overflow-hidden bg-[#050b13] px-4 py-5 sm:px-7 sm:py-8 lg:px-10">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between gap-4 pb-5">
        <Link href={`/${lang}`} className="flex items-center gap-3">
          <span className="gold-text text-3xl font-black tracking-[-0.08em]">MB</span>
          <span className="leading-tight">
            <span className="block text-sm font-bold tracking-[0.12em] text-chalk">PROF BERRADA</span>
            <span className="block text-[9px] font-bold tracking-[0.34em] text-accent">MATH ACADEMY</span>
          </span>
        </Link>
        ...
        <div className="flex min-h-[36rem] items-center p-5 sm:p-8 lg:p-10 xl:p-14">
          <div className="w-full">
            <div className="mb-7 lg:hidden">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-accent">PROF BERRADA Math Academy</p>
